...
class Meta(BaseModel):
    ...
    # NUR für Demo-Personas oder freiwillige Nutzereingabe — wird NIE aus
    # Dokumenten extrahiert (Datenschutz-Regel 2). Ohne Wert greift die
    # neutrale Standard-Anrede des Renderers.
