...
class FallDef:
    id: str
    titel: str                     # technischer Titel (Fallmatrix)
    beschreibung: str = ""         # bürgernahe Kurzbeschreibung (Startseite)
    anrede: str = ""               # Persona-Anrede, z. B. „Liebe Familie Brandt"
    finanzamt: str = "Finanzamt Musterstadt"
    jahr: int = 2024
    zusammen: bool = False
...
FAELLE: list[FallDef] = [
    FallDef(id="K01", titel="Einzel, einfach, Erstattung",
            beschreibung="Alleinstehend, mittleres Einkommen — der einfache Standardfall, mit Erstattung",
            anrede="Liebe Frau Albrecht",
            finanzamt="Finanzamt Leipzig", bundesland="Sachsen",
    ...
    FallDef(id="K02", titel="Einzel, Kapital tariflich (§ 32d Abs. 6), Nachzahlung",
            beschreibung="Alleinstehend, dazu Kapitalerträge — mit Nachzahlung",
            anrede="Lieber Herr Yıldız",
            finanzamt="Finanzamt Dortmund", bundesland="Nordrhein-Westfalen",
    ...
    FallDef(id="K03", titel="Zusammen, 2 Kinder, Kindergeld günstiger",
            beschreibung="Familie mit zwei Kindern, ein Vollzeit- und ein Teilzeiteinkommen",
            anrede="Liebe Familie Brandt",
            finanzamt="Finanzamt Rostock", bundesland="Mecklenburg-Vorpommern",
    ...
    FallDef(id="K04", titel="Zusammen, 3 Kinder, Elterngeld-PV, Soli-Milderungszone",
            beschreibung="Familie mit drei Kindern, Elterngeld, höheres Einkommen",
            anrede="Liebe Familie Weber",
            finanzamt="Finanzamt Freiburg-Stadt", bundesland="Baden-Württemberg",
    ...
    FallDef(id="K05", titel="Einzel, Rente (Besteuerungsanteil), Soli 0",
            beschreibung="Rentnerin mit kleiner Rente",
            anrede="Liebe Frau Ehlers",
            finanzamt="Finanzamt Hamburg-Nord", bundesland="Hamburg",
    ...
    FallDef(id="K06", titel="Zusammen, selbständig + gewerblich, § 35, Nachzahlung",
            beschreibung="Paar, beide selbständig bzw. mit eigenem Betrieb, Kirchensteuer",
            anrede="Liebe Familie Syed",
            finanzamt="Finanzamt München", bundesland="Bayern",
    ...
    FallDef(id="K07", titel="Einzel, V+V, Verlustvortrag § 10d, § 35a Handwerker",
            beschreibung="Alleinstehend, vermietet eine Wohnung, Handwerkerkosten",
            anrede="Lieber Herr Schneider",
            finanzamt="Finanzamt Erfurt", bundesland="Thüringen",
    ...
    FallDef(id="K08", titel="Zusammen, DBA-PV, Kirchensteuer, Faktorverfahren",
            beschreibung="Paar ohne Kinder, ein Einkommen teils im Ausland, Kirchensteuer",
            anrede="Liebe Familie Peters",
            finanzamt="Finanzamt Köln-Mitte", bundesland="Nordrhein-Westfalen",
            zusammen=True, kirchensteuer=True,
    ...
    FallDef(id="K09", titel="Einzel, ALG-I-PV, Krankheitskosten/zumutbare Belastung",
            beschreibung="Alleinstehend, niedriges Einkommen, zeitweise arbeitslos, Krankheitskosten",
            anrede="Lieber Herr Lange",
            finanzamt="Finanzamt Mainz", bundesland="Rheinland-Pfalz",
    ...
    FallDef(id="K10", titel="Änderungsbescheid, Zusammen, Realsplitting",
            beschreibung="Paar, geänderter Bescheid, Unterhaltszahlungen an Ex-Partnerin",
            anrede="Liebe Familie Nowak",
            finanzamt="Finanzamt Friedrichshain-Kreuzberg", bundesland="Berlin",
